          ...
          <AnimatePresence>
            {unmapped.map((entry, i) => (
              <motion.div
                ...
                className={`glass-panel p-10 relative overflow-hidden group border-l-8 transition-all hover:bg-white/80 ${
                   mappingId === entry.id ? 'border-l-luxury-gold bg-luxury-gold/[0.02]' : 'border-l-status-danger bg-white/60'
                } shadow-premium`}
              >
