      ...
      >
        <div className="bg-white/70 backdrop-blur-xl p-10 rounded-[32px] border border-luxury-gold/20 shadow-premium">
          <div className="flex flex-col items-center mb-10">
            ...
            <h1 className="text-2xl font-black text-luxury-text-primary uppercase tracking-[0.3em]">StockIQ</h1>
            <p className="text-luxury-text-muted text-xs font-bold uppercase tracking-widest mt-2">Hospitality Operations</p>
          </div>
